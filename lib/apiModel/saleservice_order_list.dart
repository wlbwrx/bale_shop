...
part 'saleservice_order_list.g.dart';


@JsonSerializable()
  class saleservice_order_list extends Object {
  ...
  saleservice_order_list(this.body,this.headers,this.statusCode,this.statusCodeValue,);

  factory saleservice_order_list.fromJson(Map<String, dynamic> srcJson) => _$saleservice_order_listFromJson(srcJson);

  Map<String, dynamic> toJson() => _$saleservice_order_listToJson(this);
